...
%
%\lstinputlisting[caption = {Implementación del Método de Euler para resolución del Ejemplo Numérico 1.}\label{cod:ejnonlin}]{sourcesJBBG/Incremental1dof.m}
%
%
...
% \begin{picture}(1,0.77777905)%
% \put(0,0){\includegraphics[width=\unitlength,page=1]{fig2_modif.pdf}}%
% \put(-0.00287414,0.05370452){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.27904944\unitlength}\raggedright $(0,0)$\end{minipage}}}%
% \put(0,0){\includegraphics[width=\unitlength,page=2]{fig2_modif.pdf}}%
% \put(0.49299342,0.77413208){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.37246005\unitlength}\raggedright Recta tangente\end{minipage}}}%
% \put(0,0){\includegraphics[width=\unitlength,page=3]{fig2_modif.pdf}}%
% \put(-0.00110828,0.66107249){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.37364249\unitlength}\raggedright $\lambda_k \bfv$\end{minipage}}}%
% \put(0.9233917,0.03571526){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.27904944\unitlength}\raggedright $x$\end{minipage}}}%
% \put(0.69829665,0.05725176){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.01418896\unitlength}\raggedright \end{minipage}}}%
% \put(0.03017145,0.76224563){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.37364249\unitlength}\raggedright $\lambda \bfv$\end{minipage}}}%
% \put(0,0){\includegraphics[width=\unitlength,page=4]{fig2_modif.pdf}}%
% \put(0.34857467,0.04732496){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.27904944\unitlength}\raggedright $x_k^{(1)}$\end{minipage}}}%
% \put(0,0){\includegraphics[width=\unitlength,page=5]{fig2_modif.pdf}}%
% \put(0.17771602,0.04629465){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.27904944\unitlength}\raggedright $x_k^{(0)}$\end{minipage}}}%
% \put(0,0){\includegraphics[width=\unitlength,page=6]{fig2_modif.pdf}}%
% \end{picture}%
%%	\includegraphics[width=.6\linewidth]{sourcesJBBG/fig2}
...
%  \begin{picture}(1,0.77777905)%
%\put(0,0){\includegraphics[width=\unitlength,page=1]{fig3_modif.pdf}}%
%\put(-0.00287414,0.05370452){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.27904944\unitlength}\raggedright $(0,0)$\end{minipage}}}%
%\put(0,0){\includegraphics[width=\unitlength,page=2]{fig3_modif.pdf}}%
%\put(0.49299342,0.77413208){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.37246005\unitlength}\raggedright Recta secante\end{minipage}}}%
%\put(0,0){\includegraphics[width=\unitlength,page=3]{fig3_modif.pdf}}%
%\put(-0.00110828,0.68239285){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.37364249\unitlength}\raggedright $\lambda_k \bfv$\end{minipage}}}%
%\put(0.9233917,0.03571526){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.27904944\unitlength}\raggedright $x$\end{minipage}}}%
%\put(0.69829665,0.05725176){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.01418896\unitlength}\raggedright \end{minipage}}}%
%\put(0.03017145,0.76224563){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.37364249\unitlength}\raggedright $\lambda \bfv$\end{minipage}}}%
%\put(0,0){\includegraphics[width=\unitlength,page=4]{fig3_modif.pdf}}%
%\put(0.30426179,0.05903024){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.27904944\unitlength}\raggedright $x_k^{(1)}$\end{minipage}}}%
%\put(0,0){\includegraphics[width=\unitlength,page=5]{fig3_modif.pdf}}%
%\put(0.14176406,0.05758189){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.27904944\unitlength}\raggedright $x_k^{(0)}$\end{minipage}}}%
%\put(0,0){\includegraphics[width=\unitlength,page=6]{fig3_modif.pdf}}%
%\put(0.37911227,0.05825203){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.27904944\unitlength}\raggedright $x_k^{(2)}$\end{minipage}}}%
%\end{picture}%
%%	\includegraphics[width=.6\linewidth]{sourcesJBBG/Fig3}
...
%\begin{figure}[htb]
%	\centering
%	\resizebox{\textwidth}{!}{\input{sourcesJBBG/Fig4Epscargabaja}}
...
%
%\lstinputlisting[caption = {Implementación de métodos iterativos para ejemplo numérico 2.}\label{cod:EjNum2}]{sourcesJBBG/Iterative1dof.m}
%
%
...
%	\setlength{\unitlength}{0.65\textwidth}
%  \begin{picture}(1,0.77777905)%
%\put(0,0){\includegraphics[width=\unitlength,page=1]{Fig5_modif.pdf}}%
%\put(-0.00287414,0.05370452){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.27904944\unitlength}\raggedright $(0,0)$\end{minipage}}}%
%\put(0,0){\includegraphics[width=\unitlength,page=2]{Fig5_modif.pdf}}%
%\put(0.59054248,0.74871021){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.37246005\unitlength}\raggedright radio: $\Delta \ell$\end{minipage}}}%
%\put(-0.00110828,0.60463628){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.37364249\unitlength}\raggedright $\lambda_k \bfv$\end{minipage}}}%
%\put(0.9233917,0.03571526){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.27904944\unitlength}\raggedright $x$\end{minipage}}}%
%\put(0.69829665,0.05725176){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.01418896\unitlength}\raggedright \end{minipage}}}%
%\put(0.03017145,0.76224563){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.37364249\unitlength}\raggedright $\lambda \bfv$\end{minipage}}}%
%\put(0.75211131,0.05089315){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.27904944\unitlength}\raggedright $x_k$\end{minipage}}}%
%\put(0,0){\includegraphics[width=\unitlength,page=3]{Fig5_modif.pdf}}%
%\put(0.48668934,0.2455312){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.37364249\unitlength}\raggedright $s_k$\end{minipage}}}%
%\put(0.40288814,0.65724635){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\begin{minipage}{0.37246005\unitlength}\raggedright $\bff(\bfx)$\end{minipage}}}%
%\put(0,0){\includegraphics[width=\unitlength,page=4]{Fig5_modif.pdf}}%
%\end{picture}%
%	%	\includegraphics[width=.6\linewidth]{sourcesJBBG/Fig5}
...
%\begin{figure}[htb]
%	\centering
%	\resizebox{\textwidth}{!}{\input{sourcesJBBG/Fig6Epscargabaja}}
...
%%\bigskip
%
%\lstinputlisting[caption = {Solución con Método de Longitud de Arco - Ejemplo Numérico 3.}\label{cod:EjNum3}]{sourcesJBBG/ArcLength1dof.m}
