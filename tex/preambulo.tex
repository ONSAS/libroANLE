...
\usepackage[b5paper,top=18mm,bottom=14mm,left=16.5mm,right=12.5mm,portrait]{geometry}
\usepackage[frame,a4,center]{crop}
...
\newwatermark[pages=1-200,color=red!05,angle=45,scale=2.0,xpos=0,ypos=0]{En revisión.}
...
%\fancyfoot[R]{\thepage}
\fancyfoot[C]{\scriptsize{Material en revisión. Se agradecerán avisos de errores vía \href{https://github.com/ONSAS/libroANLE/issues/new}{github.com/ONSAS/libroANLE/issues/new}}}
%\headrulewidth 0.4pt
%\footrulewidth 0 pt
